...
predicted_time = qeaware['predicted_time'].astype(float)
actual_time = qeaware['scheduled_exec_time'].astype(float)
plt.plot(x, predicted_time, '--', marker='*', color='red', label="Predicted time")
plt.plot(x, actual_time, '--', marker='+', color='blue', label="Actual execution time")
...
filename = "/home/ubuntu/phd_data/code/GPUETM/GPUETM/src/plots/data-schedule-energy/" + "predicttime" + "w_50_kmeans_small2.pdf"
