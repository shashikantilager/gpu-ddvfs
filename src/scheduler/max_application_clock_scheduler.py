    ...
    def schedule_workload(self):
        ...
        for job in job_list:
            ...
            if job.arrival_time >= elapsed_time:
                ...
                job.mem_clock, job.sm_clock = self.max_application_clocks
